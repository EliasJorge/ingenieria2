...
{	
	...
	echo "<select name='tipos' id='alojamiento'>";
	echo "<option value='0'>Elige</option>";
...
<body class="homepage">
	...
	<h2>Filtrar Busqueda </h2>
		<fieldset>
			<legend>
				<h4>A donde deseas ir? </h4>
			</legend>
			<form class="form-horizontal" action="busquedaResult.php" method="POST" onsubmit=" return validarBusquedaAvanzada(this)">
