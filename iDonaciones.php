...
<body class="homepage">
	...
	<section id="main-slider" class="center">
	   <!------agregar fecha inicio y fecha fin---------->
		...
		<hr>
		<form action="lDonaciones.php" method="POST" onsubmit="return validarFechas()" id="donaciones" name="donaciones" enctype="multipart/form-data">
			<div>
				<div>
