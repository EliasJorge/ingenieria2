...
<body class="homepage">
	...
	<section id="blog" class="container">
		<div>
       <?php 	
				$bus= "select * from valoracion_publicacion where id_publicacion = '$id' order by id_valoracion";
				$res= busqueda($bus);
				foreach ($res as $r){
					$usu= $r['id_usuario'];
...
<?php				}
	   ?>
			<div class="botonPub">	
				<input class="btn btn-primary btn-lg" id="regresar" name="regresar" type="button" value="volver" onClick="location.href = 'mostrar_publicacion.php?id=<?php echo $id ?>'"/>
			</div>
		</div>
    </section><!--/section-->
